...
start_install(){
	...
	cd ~/Downloads/
	wget https://github.com/riecointeam/riecoin/releases/download/v0.20.0-rc/riecoin-0.20.0rc1-x86_64-linux-gnu.tar.gz
	tar xvzf riecoin-0.20.0rc1-x86_64-linux-gnu.tar.gz
	...
	rm riecoin-0.20.0rc1-x86_64-linux-gnu.tar.gz
...
echo "######### RIECOIN CORE v0.20.0RC1 x86-64 GNU ##########"
echo "#######################################################"
