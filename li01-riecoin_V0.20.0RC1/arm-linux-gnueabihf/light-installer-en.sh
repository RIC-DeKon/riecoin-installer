...
start_install(){
	...
	cd ~/Downloads/
	wget https://github.com/riecointeam/riecoin/releases/download/v0.20.0-rc/riecoin-0.20.0rc1-arm-linux-gnueabihf.tar.gz
	tar xvzf riecoin-0.20.0rc1-arm-linux-gnueabihf.tar.gz
	...
	rm riecoin-0.20.0rc1-arm-linux-gnueabihf.tar.gz
...
echo "####### RIECOIN CORE v0.20.0RC1 ARM GNUEABIHF #########"
echo "#######################################################"
